...
Invariant: category-42348-3
Description: "If category is present, then there shall be a category with LOINC code '42348-3'."
Severity: #error
Expression: "sdtcCategory.empty() or sdtcCategory.exists(code = '42843-3' and codeSystem = '2.16.840.1.113883.6.1')"
